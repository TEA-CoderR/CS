...
/*int main(int argc, char const *argv[])
{
	...
	strncpy(buf, "ieeee.txt", 9);
	add_result(container, 23, buf);
	char *buf1 = calloc(sizeof(char), 20);
	strncpy(buf1, "iaaaa.txt", 9);
	add_result(container, 2, buf1);
	char *buf2 = calloc(sizeof(char), 20);
	strncpy(buf2, "iwwww.txt", 9);
	add_result(container, 20, buf2);
	char *buf3 = calloc(sizeof(char), 20);
	strncpy(buf3, "iffff.txt", 9);
	add_result(container, 18, buf3);
